...
export default function DialogView({ customer,dialog,onEdit }: DialogViewProps) {
  switch (dialog) {
    case DialogViewType.Edit:
      return (
        <>
          <DialogHeader>Edit customer destails</DialogHeader>
          <DialogDescription>Please press "Save" to update customer profile</DialogDescription>
